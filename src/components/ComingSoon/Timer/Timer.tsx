...
import DotsIcon from '../../../assets/images/comigSoon/dots.svg';
...
const Timer: FC<IProps> = ({ timer }) => {
  ...
  useEffect(() => {
    const countDown = setInterval(function () {
      ...
      const hours = Math.floor(distance / (1000 * 60 * 60) - days * 24);
  ...
  return (
    <div className={styles.container}>
      <div className={styles.item}>
        <div className={styles.block}>{days}</div>
      ...
      <div className={styles.item}>
        <div className={styles.block}>{hours}</div>
      ...
      <div className={styles.item}>
        <div className={styles.block}>{minutes}</div>
      ...
      <div className={styles.item}>
        <div className={styles.block}>{seconds}</div>
